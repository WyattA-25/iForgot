...
- Wyatt Allison: designed the frontend, built the Flask middleware, and integrated the two.
- Johnathan: built the sliding-window detection and the training foundation.
